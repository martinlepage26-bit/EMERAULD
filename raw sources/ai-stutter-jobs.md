...
flowchart LR
    ...
    EMP[Employeurs et gestionnaires]
    VEND[Fournisseurs d'IA]
    REG[Pouvoirs publics et régulateurs]
    COMM[CSA, NSA, orthophonistes, pairs]
    RES[Recherche et universités]

    PWS -->|besoins, retour d'expérience| HR
    HR -->|processus, sélection, accommodation| EMP
    EMP -->|achat, déploiement, audit| VEND
    REG -->|normes, obligations, achats publics| EMP
    COMM -->|soutien, formation, coaching| PWS
    RES -->|preuves, benchmarks, tests| VEND
...
gantt
    ...
    dateFormat  YYYY-MM
    section Employeurs
    Transparence sur l'IA et accommodations d'embauche :active, 2026-05, 6m
    Alternatives non vocales et entretiens structurés :active, 2026-05, 9m
    Audit fournisseurs et métriques d'impact : 2026-08, 12m
    section Pouvoirs publics
    Guide canadien IA et handicap :active, 2026-06, 12m
    Clauses d'achat public et documentation : 2027-01, 18m
    Financement R&D voix dysfluentes FR/EN : 2026-09, 24m

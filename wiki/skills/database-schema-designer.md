...
updated: '2026-06-26'
vault_area: wiki
canonical_path: wiki/skills/database-schema-designer.md
backlink_count: 3
backlinks:
...
**Purpose (vault-side):** data modeling, normalization, constraints, indexing, migrations, query performance considerations.

---
type: index
title: Orphan Index — Vault-Level Graph Repair 2026-05-06
aliases:
...
- index
- wiki
- orphan-index-vault-level-graph-repair-2026-05-06-md
- peer
- elemental
- assets
- review
...
updated: '2026-06-26'
vault_area: wiki
canonical_path: wiki/Orphan Index — Vault-Level Graph Repair 2026-05-06.md
backlink_count: 9
backlinks:
- '[[wiki/Home]]'
...
This generated index reflects the Obsidian-visible vault, not only the curated `wiki/` corpus. It exists to remove vault-level graph orphans while preserving the distinction between synthesized wiki notes, raw captures, archives, runtime files, and generated artifacts.

No files were moved, renamed, deleted, or merged. Links were added from index notes only.
...
- `.agent_bus` — 1
- `.claude` — 1
- `ARCHITECTURE-STATUS-MARKING-CHECKLIST.md` — 1
- `CODEX response TO RIA.md` — 1
- `SHOW-ME-WHAT-TO-DO.md` — 1
- `Untitled Kanban 1.md` — 1
- `Untitled Kanban.md` — 1
- `VAULT-LINKING-AUDIT-2026-05-01.md` — 1
- `VAULT-PRODUCTION-MANIFEST.md` — 1
- `Welcome.md` — 1
- `maps` — 1
- `raw\ sources` — 1
- `skill.md` — 1
...
<!-- BEGIN GENERATED EDITABLE MD BACKLINK INDEX 2026-06-26 -->
...
- Editable Markdown files scanned: **1437**
- Files given generated inbound links: **107**
...
- [[archive/orphan-root/Untitled Kanban 1 — empty board archived 2026-05-31]]
...
- [[assets/manuscripts/queering-neo-pagan-magic-mrw-2026/_archive_superseded_2026-05-31/source_uploads/Lepage--Queering Pagan Magic--MRW revision]]
...
<!-- END GENERATED EDITABLE MD BACKLINK INDEX 2026-06-26 -->

...
| 3 | Governance stack wired to execution | **PIPELINE LIVE 2026-07-08, closure pending** — task #1 at `routed` until its 2026-07-10 live-run evidence (QK condition 8); gate runs soft, invoked automatically by the nightly pass since task #2 (Argus F1 remediation); residual: the gate checks clearance artifacts, not their authenticity (Argus F2, open) | [[governance/EMERAULD-OS-SPEC — Governance Wiring|Governance Wiring spec]] + [[governance/tasks/README|tasks state machine]] |

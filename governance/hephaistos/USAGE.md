...
- authority-chain control lint: `python3 scripts/lint_authority_chain.py`
  or `npm run lint:authority-chain`
- local pre-commit guard installer: `npm run install:hooks`
...
| `skills/recursive-governance-method/SKILL.md` | Description: "use when chatgpt needs to..." | Patched: platform reference removed |
...
2. **Flat `SKILL_*.md` files:** RESOLVED (2026-05-02). All 14 flat shortcut files deleted.
   `extracted/` directory (80 legacy skill files) archived to `/mnt/d/HEPHAISTOS-ARCHIVE/extracted/`.
   Canonical skill path: `skills/[skill-name]/SKILL.md` (registered in SKILL-MAP.md).

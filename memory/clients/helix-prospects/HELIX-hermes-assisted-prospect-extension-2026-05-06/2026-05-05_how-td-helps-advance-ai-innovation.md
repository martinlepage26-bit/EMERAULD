...
Meet five of the organizations TD works with to accelerate AI innovation at the Bank.

## Full Text

[INNOVATION ](https://stories.td.com/ca/en//search?searchFilter_tag=innovation)

#  [5 organizations TD is working with to advance AI innovation](https://stories.td.com/ca/en/article/td-ai-innovation "5 organizations TD is working with to advance AI innovation")

6 minute read

• Nov 10, 2025

One year before TD acquired [Layer 6](https://layer6.ai/) in 2018—then an artificial intelligence (AI) startup and now a leading AI research and development centre—the Bank was already taking steps to build an AI ecosystem. 
...
TD became a founding sponsor of the [Vector Institute](https://vectorinstitute.ai/), an independent non-profit AI research facility, in 2017. Since then, the Bank has strategically developed a network made up of AI start-ups, research institutions, universities and more that are giving it insight into the next generation of talent, research and new technologies. 

"We can't do it all alone," said [Maksims Volkovs](https://stories.td.com/ca/en/article/maksims-volkovs-profile), chief AI scientist at TD. "We've developed a broad network of relationships so that we can keep our fingers on the pulse of innovation, identify promising, young talent and develop new solutions to power our AI strategy going forward." 

Here are five institutions that TD is working with to advance AI.

### **Vector Institute**

Vector was founded by Toronto-based AI entrepreneurs Jordan Jacobs and Tomi Poutanen (who co-founded Layer 6, alongside Volkovs) and Geoffrey Hinton, a University of Toronto professor sometimes referred to as the "godfather of AI." 
...
Together, they have run industry-focused AI training programs on topics such as "explainability in large language models (LLMs)" and "practical AI governance," with more than 500 TD colleagues attending. 
...
Building relationships with research institutes like Vector are important to the Bank's AI strategy, Volkovs said. TD also recently began working with [Mila](https://mila.quebec/en), an AI research institute in Quebec. TD will work with Mila professors on AI research projects, gain access to its student network for internship and co-op opportunities and participate in training programs.

### **Radical Ventures**

TD continued to build out its AI ecosystem in 2019 when it invested in [Radical Ventures](https://radical.vc/), a venture capital firm founded by Jordan Jacobs.
...
In 2021, TD invested in [Signal 1](https://signal1.ai/), an AI health start-up company that's researching and developing solutions to integrate AI into hospital workflows. 
...
The general internal medicine unit at St. Michael's Hospital in Toronto, an early adopter of the technology, has seen unexpected deaths decline by 26% during a 19-month period between 2020 and 2022, according to the [Canadian Medical Association Journal](https://unityhealth.to/2024/09/ai-tool-study/). 
...
Through the Radical Ventures Fund, TD invested in Toronto-based AI startup [Cohere](https://cohere.com/) in 2024 to test the company's LLMs and determine whether they could help the Bank refine its generative AI use cases. 
...
TD has also been testing Cohere's retrieval augmented generation capabilities as part of their collaboration. These capabilities ground a language model, like a chatbot, to a particular dataset, such as a series of policies and procedures. This means that a chatbot can't source its answers from anywhere outside a particular dataset, which enables a model to be more accurate and can help to limit its potential to hallucinate. 

### **Columbia Business School**

TD has relationships with multiple Canadian academic institutions that help it identify and assess the next generation of AI talent. This year, the Bank also began to seek out these collaborations in the U.S. and started working with the [Columbia Business School](https://business.columbia.edu/) in New York.
...
Layer 6 hires about 60% of its talent straight out of university, Volkovs said. Talent comes from leading academic institutions in Canada, the U.S. and around the world. 
...
[Meet the company processing forest debris to reduce wildfire risk  ](https://stories.td.com/ca/en/article/charm-industrial-carbon-capture)

[The TD Stories AI glossary  ](https://stories.td.com/ca/en/article/how-does-ai-work)

[How TD collaborates to fuel AI innovation  ](https://stories.td.com/ca/en/article/clean-ai)

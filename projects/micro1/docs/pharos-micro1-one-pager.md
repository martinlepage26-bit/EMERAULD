...
updated: '2026-07-08'
vault_area: projects
canonical_path: projects/micro1/docs/pharos-micro1-one-pager.md
backlink_count: 1
backlinks:
...
Frontier labs need high-quality red-teaming and governance evaluation data — not just "the model answered." They need records of *how* institutional constraints were applied, where overrides happened, and what the expert rationale was.

Our data combines large-scale operational governance traces generated through our production systems with PhD-level expert reasoning and explicit claim-boundary enforcement. This layered approach — operational volume plus structured expert annotation — is what makes the traces particularly valuable for training and evaluating models that must operate under real institutional and regulatory constraints.

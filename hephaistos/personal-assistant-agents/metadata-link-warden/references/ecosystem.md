...
canonical_path: hephaistos/personal-assistant-agents/metadata-link-warden/references/ecosystem.md
backlink_count: 1
backlinks:
...
## Placement
Metadata and Link Warden sits below the human operator and the personal-assistant orchestrator, and alongside the other bounded vault and commercialization specialists.
...
- the task would require invent rights clearance, fake backlinks, or redesign the whole graph from one note

...
canonical_path: hephaistos/personal-assistant-agents/metadata-link-warden/references/method.md
backlink_count: 1
backlinks:
...
## Core Rule
Metadata and Link Warden governs one bounded job: keep frontmatter, source flags, product states, and backlinks coherent.
...
- contradiction pressure: conflicting dates, statuses, rights flags, or related-note claims

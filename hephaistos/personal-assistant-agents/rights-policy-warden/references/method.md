...
canonical_path: hephaistos/personal-assistant-agents/rights-policy-warden/references/method.md
backlink_count: 1
backlinks:
...
## Core Rule
Rights and Policy Warden governs one bounded job: protect sellability by clearing rights, licensing, and platform-policy fit.
...
- contradiction pressure: mixed authorship, conflicting licenses, or marketplace constraints that clash with the offer

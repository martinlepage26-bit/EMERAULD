...
canonical_path: hephaistos/personal-assistant-agents/synthesis-editor/references/ecosystem.md
backlink_count: 1
backlinks:
...
## Placement
Synthesis Editor sits below the human operator and the personal-assistant orchestrator, and alongside the other bounded vault and commercialization specialists.
...
- the task would require fake certainty, clear rights, or turn a source into launch copy without a downstream brief

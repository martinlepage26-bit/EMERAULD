...
canonical_path: hephaistos/personal-assistant-agents/demand-scout/references/evolution.md
backlink_count: 1
backlinks:
...
1. confirm rankings still cite evidence rather than vibes
2. confirm weak-signal warnings are still preserved
3. confirm the agent is not drifting into final pricing or copy

...
canonical_path: hephaistos/personal-assistant-agents/offer-pricing-architect/references/ecosystem.md
backlink_count: 1
backlinks:
...
## Placement
Offer and Pricing Architect sits below the human operator and the personal-assistant orchestrator, and alongside the other bounded vault and commercialization specialists.
...
- the task would require promise services or assets that do not exist or bypass rights restrictions

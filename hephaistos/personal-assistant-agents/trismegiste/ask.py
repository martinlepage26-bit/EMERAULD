...
def query_lightrag(question: str, mode: str = "hybrid") -> str:
    ...
    try:
        ...
        return "LightRAG not running. Start with: systemctl --user start lightrag"
...
def main():
    ...
    parser.add_argument(
        "--lightrag-url", default=LIGHTRAG_URL, help="LightRAG server URL"
    )
    args = parser.parse_args()

    if args.vault:
        global VAULT_DIR, LIGHTRAG_URL

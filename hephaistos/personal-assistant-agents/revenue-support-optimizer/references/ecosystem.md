...
canonical_path: hephaistos/personal-assistant-agents/revenue-support-optimizer/references/ecosystem.md
backlink_count: 1
backlinks:
...
## Placement
Revenue and Support Optimizer sits below the human operator and the personal-assistant orchestrator, and alongside the other bounded vault and commercialization specialists.
...
- the task would require make financial commitments, promise refunds, or declare strategy truth from thin data

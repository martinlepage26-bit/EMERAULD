...
canonical_path: hephaistos/DEPLOYMENT-CHECKLIST.md
backlink_count: 1
backlinks:
...
- [ ] **Writing & Publishing Skills (10 active + 3 routing stubs):**
...
- [ ] **Meta & Composition Skills (5 active + 1 retired):**
...
- [ ] **Niche & Routing Skills (5 active):**
  - [ ] `free-tool-strategy` — ✓ SKILL.md exists
  - [ ] `hermes-dependency-mapper` — ✓ SKILL.md exists
  - [ ] `hermes-integration-monitor` — ✓ SKILL.md exists
  - [ ] `hermes-escalation-router` — ✓ SKILL.md exists
  - [ ] `naming-analyzer` — ✓ SKILL.md exists

**Active skill count: 35. Routing stubs (files on disk, not standalone targets): 9. Retired: 1.**
...
- [ ] **`queen-keyport-to-hermes.md`**
  ...
  - [ ] Mandatory gate 2: Consented Frame wisdom gate passed
...
### Gate 3: Consented Frame Operationalized as Non-Negotiable Gate

**Requirement:** Consented Frame validation is integrated into every handoff and enforces wisdom/care assessment.

- [ ] **Tier 0 (HEPHAISTOS Forging):** Consented Frame validates artifact scope
...
- [ ] **Tier 1 (Queen Keyport Governance):** Consented Frame validates governance decision
...
- [ ] **Tier 2 (Right-Arms):** Philosopher explicitly assesses wisdom
...
- [ ] **Tier 6 (Hermes Routing):** Consented Frame validates routing decisions
...
- [ ] **Escalation:** Unwise decisions escalate back to HEPHAISTOS
  - [ ] Escalation path clear: Queen Keyport → HEPHAISTOS for redesign
  - [ ] Documentation: right-arm-veto-authority.md "HEPHAISTOS Override Authority"

**Verification Method:** Search HEPHAISTOS.md, ORCHESTRATION.md, HERMES.md for "Consented Frame" and "serves genuine flourishing" — should find non-negotiable gates at every tier.
...
- [ ] **SKILL-MAP.md:** All 46 skills registered with function, trigger conditions, pairings, overlap notes
...
|---|---|---|---|
| 1 | 35 active skills + 9 routing stubs + 1 retired — SKILL.md files present | ✓ UPDATED 2026-04-18 | [ ] |

...
> The June pricing consensus above was superseded by the operator-approved v5 pyramid (4 500 / 14 500 / 29 500 CAD + 1 500 $/mois) documented in [[Areas/Lavoie/Offre de service — v5 Pyramid (2026-07-05)]] and [[Areas/Lavoie/Contrat PHAROS x Groupe Lavoie — v5 Signature Track (2026-07-08)]]. This snapshot remains a faithful record of the June council rounds; the v5 notes are authoritative for current pricing.

...
> The "diagnostic + Forfait A" pricing recorded above as settled is no longer the current Lavoie instrument. The operator-approved v5 pyramid ([[Areas/Lavoie/Offre de service — v5 Pyramid (2026-07-05)]] and [[Areas/Lavoie/Contrat PHAROS x Groupe Lavoie — v5 Signature Track (2026-07-08)]]) prices the engagement at 4 500 / 14 500 / 29 500 CAD plus 1 500 $/mois recurring. The "blocked on A1–A5" framing was also superseded by the two-workstream operator decision of 2026-07-08. This snapshot stays unedited as a faithful record of the 2026-07-06 council state; treat the v5 notes as authoritative for anything current.

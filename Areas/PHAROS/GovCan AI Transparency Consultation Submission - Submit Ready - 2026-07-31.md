# AI Transparency That Canadians Can Use
...
Email: ml@pharos-ai.ca / martinlepage.ai@gmail.com

Respondent profile: Chercheur indépendant / independent researcher; Founder, President and Chief Officer of Trust and Governance, PHAROS AI Governance Research & Practice.

## Executive Summary

Canada should treat AI transparency as an operational accountability system, not merely as a disclosure exercise. A label that says "AI was used" can be useful, but it does not by itself let a person contest a decision, help a business assess a vendor, or help a regulator reconstruct what happened after an incident. Transparency becomes trustworthy only when it produces usable evidence, clear responsibilities, and practical routes to interruption, correction, escalation, and review.

This submission recommends a proportionate Canadian approach built around five linked measures:

1. A Canadian AI Transparency Packet standard for developers, deployers, procurers, and regulators.
2. Tiered disclosure duties that distinguish public notices, affected-person explanations, business due diligence, and protected regulator access.
3. Actionable interaction transparency that tells people what the AI is doing, what consequence may follow, and how to reach review or recourse.
4. Serious AI incident and near-miss reporting designed around harm, recurrence risk, and evidence preservation.
5. Agentic AI transparency requirements focused on identity, delegated authority, tool use, approvals, logs, and chain of custody.

The core test should be practical: what can the recipient do with this information? If a Canadian is told that an AI system affected them, they should know who used it, for what purpose, what consequence followed, what evidence exists, and how to challenge or correct the result. If a business is asked to adopt an AI tool, it should be able to inspect the system's role, limitations, data dependencies, oversight requirements, logging capacity, change history, and incident route. If a regulator or researcher needs to understand emerging harms, the relevant evidence should not be scattered across vendors, platforms, integrators, and deployers in incompatible formats.
...
## Recommended Instrument: A Canadian AI Transparency Packet
...
This packet should scale by risk and role. A small business deploying a low-risk chatbot should not face the same requirements as a company selling an AI hiring tool, a healthcare triage system, or an autonomous procurement agent. But every organization using AI should be able to answer the basic governance question: if the system fails, what record allows another person to reconstruct what happened?

## Responsibility Across the AI Value Chain

Transparency duties should follow operational control.

Developers should provide the documentation, technical hooks, evaluation boundaries, provenance features, logging capacity, update notices, and claims/non-claims registers that deployers need to disclose accurately.

Deployers should carry primary responsibility for user-facing notices, affected-person explanations, human review, recourse routes, operational logging, and incident escalation because they control the use case and the relationship with the affected person.

Platforms and publishers should preserve provenance metadata where feasible, display consistent labels in high-risk synthetic media contexts, and provide reporting channels for deceptive or harmful AI-generated content.

Procurers should require transparency packets, change notification, logging commitments, incident routes, and evidence-retention terms before adoption.

Regulators should define protected channels for deeper technical and operational evidence, publish common templates, and coordinate incident taxonomy across existing federal, provincial, territorial, and sectoral regimes.
...
6. Non-deceptive: avoiding anthropomorphic design that makes a machine interaction appear human.
...
This structure should be reinforced by standard templates. Without a common format, businesses will continue to receive inconsistent vendor documents, regulators will struggle to compare incidents, and affected people will receive disclosures that are technically present but practically unusable.
...
Martin Lepage, PhD, is an independent researcher and the Founder, President and Chief Officer of Trust and Governance at PHAROS AI Governance Research & Practice, based in Quebec. His work focuses on making AI governance operational: translating principles, standards, and institutional obligations into workflow gates, evidence trails, decision records, escalation paths, and incident response practices that organizations can actually use. PHAROS develops constraint-first governance methods for AI systems that must withstand procurement review, audit, public scrutiny, and post-incident reconstruction. Lepage's research background in religious sciences and cultural analysis informs his attention to legitimacy, authority, ritualized procedure, and the social consequences of technical systems. In AI governance, he works at the intersection of transparency, accountability, human oversight, documentation, and organizational control. His practice emphasizes that trust is not a tone or a promise; it is an artifact produced by records, responsibilities, review rights, and the ability to interrupt or correct harmful decisions. He writes and advises on governance architecture for high-stakes AI adoption, with particular interest in public services, professional decision-making, agentic AI, and evidence-based transparency regimes that remain usable for citizens, SMEs, procurers, and regulators alike. He welcomes follow-up at ml@pharos-ai.ca or martinlepage.ai@gmail.com from officials reviewing this public consultation submission.
